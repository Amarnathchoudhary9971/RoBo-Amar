...
function takeCommand(message) {
    ...
    if (message.includes("hello") || message.includes("hello Amar") || message.includes("hello robo amar")) {
    ...
    else if(message.includes("time"))
    {
        ...
        else if(message.includes("prateek") || message.includes("pratik"))
        {
            speak("prateek is amar friend");
        }
        else if(message.includes("amar") || message.includes("amarnath"))
            {
                speak("amar is my creator");
            }
            else if(message.includes("akash") || message.includes("aakash"))
                {
                    speak("akash amar ka bhai hai aur uske papa ka naam sarvesh choudhary hai aur mummy ka naam rani choudhary hai");
                }
                    ...
                    speak("I was created by Amar sir, a talented computer science engineer.");
                }
